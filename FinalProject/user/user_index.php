    ...
    <body>
        ...
        <div class="grid">
            <div class="grid-item">
              ...
              <?= " <img src='$image' height='200px' alt='Venue Image' width='250px';' /> "; ?>
                <div class="card-content">
                  <h1 class="card-header"><?php echo $row['event'] ?></h1>
                  <p class="card-text">
        ...
        <footer class="footer">
            <div class="footer-top container">
                <div class="footer-hours">
                    ...
                    <p><span class="days">Monday</span><br> <span class="timing">10am - 6pm</span></p>
                    <p><span class="days">Tuesday</span><br> <span class="timing">10am - 6pm</span></p>
                    <p><span class="days">Wednesday</span><br> <span class="timing">8am - 6pm</span></p>
                    <p><span class="days">Thursday</span><br> <span class="timing">8am - 6pm</span></p>
                    <p><span class="days">Friday</span><br> <span class="timing">6am - 8pm</span></p>
                    <p><span class="days">Satday</span><br> <span class="timing">6am - 8pm</span></p>
                </div>
